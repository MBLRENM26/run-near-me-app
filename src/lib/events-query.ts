...
export const DISCOVERY_EVENT_COLUMNS =
  "id, slug, name, date_raw, sort_date, town, county, region, distances, distance_type:distances, distance_tags, terrain_tags, entry_fee, entry_url, organiser_url, is_featured, date_is_estimated, is_recurring";
